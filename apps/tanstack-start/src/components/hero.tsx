...
const Hero = React.memo(() => {
    return (
        <section
            className="relative flex flex-col items-center justify-start px-6 pt-20 md:pt-24"
            style={{
      ...
      `}</style>
            ...
            <aside className="mb-8 inline-flex flex-wrap items-center justify-center gap-2 px-4 py-2 rounded-full border border-gray-700 bg-gray-800/50 backdrop-blur-sm max-w-full">
                <span className="text-xs text-center whitespace-nowrap" style={{ color: "#9ca3af" }}>
                    Now with full TanStack Start support
                </span>
                <a
                    href="#new-version"
            ...
            >
                The Modern Authentication for
                <span className="ml-3 text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-violet-600 dark:from-blue-400 dark:to-violet-400">
                    TanStack Start
                </span>
            </h1>
            ...
            <div className="flex items-center gap-4 relative z-10 mb-16">
                <Button type="button" size="lg" aria-label="Get started with the template">
                    Get started
                </Button>
                <Button variant="secondary" size="lg" aria-label="Get started with the template">
                    GitHub
                </Button>
            </div>
        </section>
