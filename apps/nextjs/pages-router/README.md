...
This project demonstrates Aura Auth authentication using [Aura Auth documentation](https://aura-stack-auth.vercel.app/docs/introduction) in an [Next.js](https://nextjs.org/) application.
...
```bash
pnpm dev --filter=pages-router
```

### Or manually from the root directory

```bash
cd apps/pages-router
pnpm install
pnpm dev
```
