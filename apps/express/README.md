...
This project demonstrates **Aura Auth** authentication using [Aura Auth documentation](https://aura-stack-auth.vercel.app/docs/introduction) in an [Express](https://expressjs.com/) application.
