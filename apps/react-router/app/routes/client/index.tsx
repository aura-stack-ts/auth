        ...
        <main className="w-11/12 min-h-container max-w-5xl mx-auto content-center">
            <section className="max-w-lg mx-auto space-y-8">
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-white">Aura Auth + React Router Client Components</h1>
                    <p className="mt-2 text-base text-white/70 max-w-3xl">
                        Official React Router demo to showcase @aura-stack/react-router authentication library with Client Side
