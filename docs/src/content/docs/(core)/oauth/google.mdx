...
1. Navigate to your Google profile and go to **Settings > Developer settings > OAuth Apps**.
2. Click **Client Credentials**.
3. Fill in the "Application name" and "Homepage URL".
4. Set the **Authorization callback URL** to `http://localhost:3000/auth/callback/google`.
