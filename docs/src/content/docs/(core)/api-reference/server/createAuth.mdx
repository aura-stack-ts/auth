...
For the full option reference (`schema`, `unknownKeys`, `skipValidation`), validator support across Zod/Valibot/ArkType/TypeBox, and type inference with `InferUser`/`InferSession`, see [Identity Schema](/docs/configuration/identity).
