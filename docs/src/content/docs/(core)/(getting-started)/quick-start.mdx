...
<Tabs items={["Fullstack", "Backend"]} persist groupId="integration-id">

<Tab value="Fullstack">

<Tabs items={["Core", "Next.js App Router", "Next.js Pages Router", "React Router v7", "TanStack Router", "Nuxt 4"]} persist groupId="framework-id">
