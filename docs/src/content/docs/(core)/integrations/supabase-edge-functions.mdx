...
description: Integrate Aura Auth and Supabase Edge Functions
---

This guide walks you through to implement Aura Auth in a Supabase Edge Functions application with a complete support.
If you haven't configured Aura Auth yet, start with the [Installation Guide](/docs/installation) and [Quick Start Guide](/docs/quick-start) to set up your Auth instance and environment variables. Then follow the steps in this guide to integrate Aura Auth with your Supabase Edge Functions application.
