---
title: Astro
description: Integrate Aura Auth and Astro
---

This guide walks you through implementing Aura Auth in an Astro application with complete support.
If you haven't configured Aura Auth yet, start with the [Installation Guide](/docs/installation) and [Quick Start Guide](/docs/quick-start) to set up your Auth instance and environment variables. Then follow the steps in this guide to integrate Aura Auth with your Astro application.
