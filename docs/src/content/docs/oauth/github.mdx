...
Set up the `GitHub` authorization provider in your Aura Auth instance.

---

## What you'll build

Through this quick start guide you are going to learn and understand the basics and how to set up the `GitHub` provider for Aura Auth.
...
- [Sign In to GitHub (Client & Server)](#sign-in-to-github-client--server)
- [Resources](#resources)
