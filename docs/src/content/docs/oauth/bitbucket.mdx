...
description: Add Bitbucket authorization provider to Aura Auth to authentication and authorize
---
...
- [Bitbucket OAuth App](#bitbucket-oauth-app)
...
- [Sign In to Bitbucket (Client & Server)](#sign-in-to-bitbucket-client--server)
- [Resources](#resources)
...
`http://localhost:3000/auth/signIn/bitbucket`
...
- [Bitbucket - Authorizing OAuth Apps](https://developer.atlassian.com/cloud/bitbucket/oauth-2/)
