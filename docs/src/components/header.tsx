...
export const Header = () => {
    ...
    return (
        <header>
            <nav data-state={menuState && "active"} className="fixed z-20 w-full px-2 group border-b border-white/20 bg-black">
                <div className={cn("mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-0")}>
