    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-1 divide-y divide-border md:grid-cols-2 md:div:odd:border-r md:div:odd:border-border md:div:nth-[3]:border-b-0">
                <div className="px-6 py-8 transition-colors hover:bg-primary-foreground/10 md:py-10">
                    <h4 className="mb-2 text-lg font-semibold text-primary font-mono">basePath</h4>
                    <p className="text-base text-primary-foreground leading-relaxed">
                        Base path for all authentication routes and endpoints
                    </p>
                </div>
                <div className="px-6 py-8 transition-colors hover:bg-primary-foreground/10 md:py-10">
                    <h4 className="mb-2 text-lg font-semibold text-primary font-mono">oauth</h4>
                    <p className="text-base text-primary-foreground leading-relaxed">
                        Configure OAuth 2.0 providers and their credentials
                    </p>
                </div>
                <div className="px-6 py-8 transition-colors hover:bg-primary-foreground/10 md:py-10">
                    <h4 className="mb-2 text-lg font-semibold text-primary font-mono">cookies</h4>
                    <p className="text-base text-primary-foreground leading-relaxed">
                        Customize session cookie behavior, security, and settings
                    </p>
                </div>
                <div className="px-6 py-8 transition-colors hover:bg-primary-foreground/10 md:py-10">
                    <h4 className="mb-2 text-lg font-semibold text-primary font-mono">secret</h4>
                    <p className="text-base text-primary-foreground leading-relaxed">
