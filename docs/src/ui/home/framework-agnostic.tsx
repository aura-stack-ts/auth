...
const runtimes = [
    ...
    },
    {
        ...
        logo: (
            <svg className="size-10" viewBox="0 0 256 256" fill="none">
                <path d="M128 0C57.308 0 0 57.308 0 128s57.308 128 128 128 128-57.308 128-128S198.692 0 128 0z" fill="#FBF0DF" />
...
export const FrameworkAgnostic = () => {
    return (
        <section className="py-20 px-6 border-t border-white/10 bg-gradient-to-b from-transparent to-purple-950/10">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold mb-4 text-white md:text-5xl">Framework-Agnostic</h2>
                    <p className="text-lg text-white/70 max-w-2xl mx-auto">
                        Write once, run anywhere. Aura Auth works with any JavaScript runtime that supports the Web
                ...
                <div className="grid gap-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mb-12">
                    {runtimes.map((runtime) => (
                        <div
                            key={runtime.name}
                            className="flex flex-col items-center justify-center p-6 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300"
                        >
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="p-8 rounded-xl border border-white/10 bg-white/5">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start gap-3">
                                <Check className="size-6 text-green-400 flex-shrink-0 mt-0.5" />
                                <span className="text-white/80">No framework-specific dependencies or lock-in</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="size-6 text-green-400 flex-shrink-0 mt-0.5" />
                                <span className="text-white/80">Deploy to any platform that supports modern JavaScript</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <Check className="size-6 text-green-400 flex-shrink-0 mt-0.5" />
